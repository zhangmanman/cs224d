...
### YOUR CODE HERE
REGULARIZATION = [0.5, 1e-1, 1e-2, 1e-3, 1e-5, 1e-6, 1e-7]
...
### YOUR CODE HERE
# tempWeights = results[0]["weights"]
# tempReg = results[0]["reg"]
tempDevAccuracy = results[0]["dev"]
for result in results:
    if result["dev"] >= tempDevAccuracy :
        tempDevAccuracy = result["dev"]
